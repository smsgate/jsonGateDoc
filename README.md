...
* [Запрос ссылки на пополнение баланса](https://github.com/smsgate/jsonGateDoc/blob/master/README.md#Запрос-ссылки-на-пополнение-баланса)
...
* [Запрос на получение данных последних 10 SMS](https://github.com/smsgate/jsonGateDoc/blob/master/README.md#Запрос-на-получение-данных-последних-10-sms)
...
* [Запрос на получение реестра имен отправителей](https://github.com/smsgate/jsonGateDoc/blob/master/README.md#запрос-на-получение-реестра-имен-отправителей)
* [Запрос на добавление удаление имен отправителей в реестре имен отправителей](https://github.com/smsgate/jsonGateDoc/blob/master/README.md#запрос-на-добавление-удаление-имен-отправителей-в-реестре-имен-отправителей)
...
```json
{
	"sms":[
		...
		{"base":"4","phone":79801234567,"id_sms":"ID SMS в системе для проверки статуса","parts":"1","action":"Статус/сообщение об ошибке"}
		{"base":"4","phone":79801234568,"id_sms":"ID SMS в системе для проверки статуса","parts":"1","action":"Статус/сообщение об ошибке"}
	]
}
```
PHP (массив, полученный через php функцию json_decode):
...
Array(
	[sms] => Array(
		...
		[2] => Array ( [base] => 4 [phone] => 79801234567 [id_sms] => ID SMS в системе для проверки статуса [parts] => 1 [action] => Статус/сообщение об ошибке )
		[3] => Array ( [base] => 4 [phone] => 79801234568 [id_sms] => ID SMS в системе для проверки статуса [parts] => 1 [action] => Статус/сообщение об ошибке )
	)
)
```
...
```json
{
	...
	"sms":[
		{"area":"МТС","number":"323","price":"1.1","type_sms":"sms","type_text":"Рекламные","MCC":"250","MNC":"1"},
		{"area":"Мегафон","number":"178","price":"2","type_sms":"sms","type_text":"Сервисные","MCC":"250","MNC":"2"}
	]
}
```
PHP (массив, полученный через php функцию json_decode):
...
Array (
	...
	[sms] => Array (
		[0] => Array ( [area] => МТС [number] => 323 [price] => 1.1 [type_sms] => sms [type_text] => Рекламные [MCC] => 250 [MNC] => 1 )
		[1] => Array ( [area] => Мегафон [number] => 178 [price] => 2 [type_sms] => sms [type_text] => Сервисные [MCC] => 250 [MNC] => 2 )
	)
)
```
...
{
	"stats":[
		{"id_sms":"100123","operator":"МТС","name_delivery":"Названиерасылки","phone":"79001234567","originator":"SENDER_1","time":"2016-03-09 20:37:02","status":"deliver","status_translate":"Доставлено","text":"ТекстSMS","price":"1.5","num_parts":"2"},
		{"id_sms":"100124","operator":"МТС","name_delivery":"Названиерасылки","phone":"79001234568","originator":"SENDER_1","time":"2016-03-09 20:37:02","status":"deliver","status_translate":"Доставлено","text":"ТекстSMS","price":"1.5","num_parts":"2"}
...
Array ( 
	[stats] => Array (
		[0] => Array ( [id_sms] => 100123 [operator] => МТС [name_delivery] => Названиерасылки [phone] => 79001234567 [originator] => SENDER_1 [time] => 2016-03-09 20:37:02 [status] => deliver [status_translate] => Доставлено [text] => ТекстSMS [price] => 1.5 [num_parts] => 2 )
		[1] => Array ( [id_sms] => 100124 [operator] => МТС [name_delivery] => Названиерасылки [phone] => 79001234568 [originator] => SENDER_1 [time] => 2016-03-09 20:37:02 [status] => deliver [status_translate] => Доставлено [text] => ТекстSMS [price] => 1.5 [num_parts] => 2 )
	)
)
```
